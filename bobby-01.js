...
// const carlight = new THREE.PointLight(0x062d89, 100);
// carlight.position.set(0, 2, -10);
// scene.add(carlight);
// const helper = new THREE.PointLightHelper(carlight);
// scene.add(helper);

const carGeo = new THREE.CircleGeometry(0.2, 36);
const imgLoader = new THREE.TextureLoader();
const carMat = new THREE.MeshBasicMaterial({
    color: 0x40DFEF0,
    map: imgLoader.load('jinly-car-lego.png'),
});
const car = new THREE.Mesh(carGeo, carMat);
car.position.set(0.05, 2, -5);
scene.add(car);
